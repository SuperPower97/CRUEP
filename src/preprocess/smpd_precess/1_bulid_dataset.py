...
def process_meta_data(path):
    ...
    train_additional_information = pd.read_json(r"./datasets/SMPD/origin/train_additional_information.json")

    train_category = pd.read_json(r"./datasets/SMPD/origin/train_category.json")

    train_temporalspatial_information = pd.read_json(r"./datasets/SMPD/origin/train_temporalspatial_information.json")

    train_user_data = pd.read_json(r'./datasets/SMPD/origin/train_user_data.json')

    label_data = pd.read_csv(r'./datasets/SMPD/origin/train_label.txt', header=None)

    train_text = pd.read_json(r"./datasets/SMPD/origin/train_text.json")
...
if __name__ == "__main__":
    ...
    path = r"./datasets/SMPD/origin/dataset.pkl"

    process_meta_data(path)
