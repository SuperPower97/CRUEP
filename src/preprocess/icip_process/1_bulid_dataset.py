...
def process_meta_data(path):
    ...
    headers = pd.read_csv(r"./datasets/ICIP/origin/headers_TRAIN.csv")

    img_info = pd.read_csv(r"./datasets/ICIP/origin/img_info_TRAIN.csv")

    popularity = pd.read_csv(r"./datasets/ICIP/origin/popularity_TRAIN.csv")
...
def process_user_data(dataset, path):
    users = pd.read_csv(r"./datasets/ICIP/origin/users_TRAIN.csv")
...
if __name__ == "__main__":
    ...
    path = r"./datasets/ICIP/origin/dataset.pkl"

    dataset = process_meta_data(path)
    print('Process meta data done!')

    process_user_data(dataset, path)
